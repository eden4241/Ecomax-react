...
import { retrieveChosenProducts, retrieveRestaurant } from "./selector";
...
export default function ChosenProducts(props: ChosenProductsProps) {
  const { onAdd } = props;
  const { productId } = useParams<{ productId: string }>();
  const { setRestaurant, setChosenProducts } = actionDispach(useDispatch());
  const { chosenProducts } = useSelector(chosenProductsRetriever);
